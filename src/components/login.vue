<template>
  <div style="width: 100%; height: 100%"
    ...
    <div style="position: absolute;margin-top: 70px; margin-left: 500px"><span style="font-size: 40px; font-weight: bolder;color:rgba(255,255,255,0.9) ">金桥学员成长跟踪系统</span></div>
