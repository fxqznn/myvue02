                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input class="paperview-input-text"
                                ...
                                @blur="editSum1(scope.row.sumscore)"
                      ></el-input>
                    </template>
                  </el-table-column>
                </el-table>
    ...
    methods:{
      ...
      editSum1(sumscore){
        if (sumscore<0||sumscore>100){
          ...
          axios.get("http://localhost:8081/updateApp02?sumscore="+sumscore+"&&sid="+this.student.sid+"&&type="+1).then(res => {
            if (res.data==1){
      ...
      scoreEdit1(cname,score){
        if(score<0||score>100){
          ...
          axios.get("http://localhost:8081/updateEmpScore?cname="
            + cname + "&&score=" + score + "&&eid=" + this.eid + "&&type=" + 1
